    ...
    return (
        <div className="store-card card-box">
            ...
            <div className="store-details details-box p-3 text-center">
                ...
                <h6 className="products-type fw-bold mb-4">{t("Products Type")} : {storeDetails.productsType}</h6>
                <h6 className="products-description fw-bold">{t("Products Description")} : {storeDetails.productsDescription}</h6>
            </div>
        </div>
    );
}