    ...
    return (
        <div className="privacy-policy-and-conditions caption-page">
            ...
            {!isLoadingPage && !isErrorMsgOnLoadingThePage && <>
                <Header />
                <div className="page-content page text-white ps-4 pe-4 pb-5">
                    <div className="container-fluid">
                        ...
                        <div className="content">
                            ...
                            <ul>
                                ...
                                <li className="mb-4">{t("'The website' refers to the electronic website, whose main page is identified by an address, and any application for mobile devices or desktop computer application developed by ubuyblues or on its behalf")} .</li>
