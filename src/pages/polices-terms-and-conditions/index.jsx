                ...
                <div className="page-content text-white p-4">
                    <div className="container-fluid">
                        ...
                        <div className="content">
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("How we protect your personal data ?")} .</h2>
                            ...
                            <ol>
                                <li>{t("Physical measures include locked file cabinets, restricted access to offices, and alarm systems")}</li>
                                <li>{t("Technological tools such as password encryption and encryption using best practices in this field in general")}</li>
                                <li>{t("Regulatory controls, confidentiality agreements, restricted access on a need-to-know basis, employee training, and security clearances")}</li>
                                <li>{t("Online security is enhanced through the integration of measures such as encryption tools and authentication to protect your personal data from unauthorized use. Firewalls are used to protect our servers and network from unauthorized user access and tampering with files and other personal data we store. Additionally, we conduct regular malware scans to prevent data breaches")}</li>
                                <li>{t("Your personal data is contained behind secured networks and can only be accessed by a limited number of individuals who have special access rights to these systems and are required to keep the personal data confidential. In addition, all sensitive personal data and credit card information you provide is encrypted via Secure Socket Layer (SSL) technology")}</li>
                            </ol>
                            <h2 className="fw-bold mb-4 h3">{t("Changing the Purpose")} .</h2>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Aggregated or Pre-classified Data")} .</h2>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Consent, Compensation, and Liability")} .</h2>
                            ...
                            <ol>
                                <li>{t("The use or access to, or inability to use, the information or branching links available on this website or Asfour International's services or any vendor services")} .</li>
                                <li>{t("Your provision of any information, including your personal data")}</li>
                                <li>{t("Any failure, delay, error, interruptions, or inaccuracies directly or indirectly resulting from any cause, including but not limited to unauthorized access or misuse of personal data by any third party, network service failures, or the operation of this website or any solution operating this website")} .</li>
                                <li>{t("Actions or negligence of Asfour International or any of its affiliated external service providers, agents, or employees")} .</li>
                            </ol>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Customer Behavior Policy")} .</h2>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Complaint Escalation Process")} .</h2>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Intellectual property rights")} .</h2>
                            ...
                            <h2 className="fw-bold mb-4 h3">{t("Changes to the Privacy Notice")} .</h2>
                            <p className="mb-4">{t("The last modification: (February 15, 2024)")} .</p>
                            <h2 className="fw-bold mb-4 h3">{t("Contact us")} .</h2>
                            ...
                            <a href="mailto:info@asfourintlco.com">info@asfourintlco.com</a>
                        </div>
                    </div>
                </div>
            </> : <LoaderPage />}
