...
import AsfourLogo from "../../../public/images/Logo-ASFOUR-White-footer.png";
    ...
    return (
        <div className="page-not-found d-flex align-items-center justify-content-center flex-column">
            ...
            <div className="page-content p-4 text-center">
                <img src={AsfourLogo.src} alt="asfour logo !" className="mb-4 d-block mx-auto" />
                <BiError className="error-404-icon" />
                <h1 className="mb-3">Sorry,</h1>
                <h2 className="mb-3">this page could not be found.</h2>
                <h3 className="mb-4">Something went wrong. The page you were looking for could not be found. Please check the URL</h3>
