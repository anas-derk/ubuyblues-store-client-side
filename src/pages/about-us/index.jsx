            ...
            <div className="page-content text-white p-4">
                <div className="container-fluid">
                    ...
                    <div className="content">
                        ...
                        <p>{t("In summary, we are Asfour International, a leading wholesale and retail trade company, offering high-quality products at competitive prices and excellent customer service. We are committed to meeting your needs and achieving your satisfaction, striving for sustainable success in our business")} .</p>
                    </div>
                </div>
            </div>
        </div>
